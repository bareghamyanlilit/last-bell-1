...
export function TimeBox() {
  ...
  return (
     <motion.section {...anim}  className="  flex flex-col gap-5 text-center  text-vrayi  px-0 mb-5">
...
const TimeBoxItem = ({ label, value }: any) => (
  <div className="  text-[40px] px-1 text-center ">
    <h2 className="mt-1 FontAdamathuz">{value}</h2>
  </div>
);
